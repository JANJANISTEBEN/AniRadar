...
public class MangaData {
    ...
    private PublishedDate published;
    ...
    public PublishedDate getPublished() {
        return published;
    }
    
    public void setPublished(PublishedDate published) {
    ...
    public String getPublishedString() {
        if (published != null && published.getString() != null) {
            return published.getString();
        }
        return "Unknown";
    }
